...
public class PasswordGeneratorService {
    ...
    public PasswordRecord generatePasswordWithParam(int size, boolean specialChars, boolean upperCase, boolean withNumbers){
     ...
     */
    private Integer[] generateRandomSizedAsciiIntegerArray(){
        Integer[] asciiArray;
    ...
    private String convertAsciiArray(Integer[] asciiArray){
